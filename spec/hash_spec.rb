...
describe Csvify do
  context "Hash" do
    ...
    it 'correctly produce the csv string without any options' do
    ...
    it 'correctly produce the csv string with exclude options(one field from child resource)' do
    ...
    it 'correctly produce the csv string with exclude options(a child resource)' do
    ...
    it 'correctly produce the csv string with exclude options(field from parent resource)' do
    ...
    it 'correctly produce the csv string with exlude options(mixed)' do
